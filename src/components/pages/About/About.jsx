    ...
    >
      <StyledHome>
        ...
        >
          ...
          Mohammed Asil is a designer and front-end developer dedicated to crafting bespoke digital experiences.

          He combines branding and web design to create thoughtful, modern identities. Guided by minimalism and attention to detail, he designs tailored experiences that bring each brand's vision to life with clarity and elegance. Follow him on Twitter and Instagram for updates.
          </div>
          <div style={{display: 'flex', gap: '1rem', justifyContent: 'center', marginTop: '1rem'}}>
            <a className="button big" href="https://x.com/AsilRabide2674" target="_blank" rel="noopener noreferrer">Twitter</a>
            <a className="button big" href="https://www.instagram.com/mohamedasilasil/" target="_blank" rel="noopener noreferrer">Instagram</a>
          </div>
        </div>
